...
class MessageManager:
    ...
    def parse(self, msg):
        ...
        elif cmd in (MSG_CORE_LIST, MSG_OWNER_LIST, MSG_CROSS_REFFERENCE, COMPLETE_CROSS_REFERENCE, MSG_NEW_TRANSACTION, MSG_NEW_BLOCK, RSP_FULL_CHAIN, MSG_ENHANCED):#RAFT_TIMER_DECREMENT,
