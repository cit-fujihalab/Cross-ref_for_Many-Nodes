...
# not pycrypto
# https://python5.com/q/zyxtsovg
# PyCryptoを使用しているかどうかを確認し、使用している場合はアンインストールして、PyCryptoのフォークであるPyCryptodomeをインストールします。
# project issue pageで述べたように、PyCryptoは死んでいます
# これらのライブラリは両方とも共存できるため、問題になる可能性もあります。
